...
Работа над исправлениями и текущий статус отслеживаются в
[`SECURITY_REMEDIATION_PLAN.RU.md`](SECURITY_REMEDIATION_PLAN.RU.md). Этот
отчёт сохранён как исходная оценка и не описывает состояние рабочей ветки с
исправлениями.
